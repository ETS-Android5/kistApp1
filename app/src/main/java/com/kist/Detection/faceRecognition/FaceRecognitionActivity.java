...
package com.kist.Detection.faceRecognition;
...
import com.kist.Detection.customview.OverlayView.DrawCallback;
import com.kist.Detection.env.BorderedText;
import com.kist.Detection.env.ImageUtils;
import com.kist.Detection.env.Logger;
import com.kist.Detection.faceRecognition.tflite.TFLiteObjectDetectionAPIModel;
import com.kist.Detection.faceRecognition.tracking.FaceMultiBoxTracker;
...
//  //private static final String TF_OD_API_MODEL_FILE = "facenet_hiroki.tflite";
  ...
  private FaceMultiBoxTracker tracker;
  ...
  public void onPreviewSizeChosen(final Size size, final int rotation) {
    ...
    tracker = new FaceMultiBoxTracker(this);
